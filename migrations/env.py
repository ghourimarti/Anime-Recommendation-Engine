"""Alembic environment — async-aware. Reads DATABASE_URL from env and uses
anime_core's metadata.
"""
...
from anime_core.db.models import Base
...
def run_migrations_offline() -> None:
    """Run migrations in offline mode (emit SQL without touching the DB)."""
    context.configure(
        url=_get_url(),
